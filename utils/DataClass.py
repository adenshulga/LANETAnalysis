...
class ProcessedDataset(ABC):
    ...
    @abstractmethod
    def conf_scores_test(self):
        pass

    @abstractmethod
    def conf_scores_valid(self):
        pass
...
class DataClass:
    ...
    def __init__(self, processed: ProcessedDataset) -> None:
        ...
        self.probas_test = sigmoid(self.conf_scores_test)
        self.probas_valid = sigmoid(self.conf_scores_valid)
...
class ProcessDNNTSPFile(ProcessedDataset):
    ...
    path_to_preds = f'/notebook/DNNTSP/model_pred_and_gt'
